        ...
        <div class="tour-list">
            ...
            <div class="tour-card">
                <div class="tour-card-inner">
                    ...
                    <?php if ($status !== 'Sold Out' && $ticket_url) : ?><a href="<?php echo esc_url($ticket_url); ?>" class="btn btn-primary">Get Tickets</a><?php else : ?><button class="btn btn-ghost" disabled>Notify Me</button><?php endif; ?></div>
                </div>
            </div>
            <?php endwhile; wp_reset_postdata(); else : ?><p style="text-align:center;color:var(--muted-foreground);">No tour dates yet.</p><?php endif; ?>
        </div>
